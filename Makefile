...
SRCS_LEXER = lexer.c is_function.c lst_function.c free_function.c init_datas.c lexer_utils.c advance_space.c

SRCS_PARSER = parse.c parse_utils.c init_lst_function.c parse_lst_function.c create_lst.c free_node.c
